...
//         icon: Mail,
//         label: "Email",
//         value: "vermaeudes@gmail.com",
//         href: "mailto:vermaeudes@gmail.com"
//     },
//     {
//         icon: Phone,
//         label: "Phone",
...
//             <div className="grid-cols-1 lg:grid-cols-2 max-w-5xl mx-auto">
  ...
  return (
    <section id="contact" className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        {/* Grille avec hauteur égale sur les deux colonnes */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* Formulaire */}
          <div className="glass p-8 rounded-3xl border border-primary/30 animate-fade-in animation-delay-300 h-full flex flex-col justify-between">
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
          ...
          {/* Colonne de droite alignée parfaitement de haut en bas */}
          <div className="flex flex-col justify-between gap-6 animate-fade-in animation-delay-400 h-full">
            <div className="glass rounded-3xl p-8">
